...
struct cache_t {
	...
	// vicitm caches start
	counter_t vc_misses;  /* victim cache misses */
	counter_t vc_hits; /* victim cache hots */
	// victim cache miss

	// miss cache parameter
	counter_t mc_misses;
	counter_t mc_hits;

	// selective cache parameter
	counter_t sel_misses;
	counter_t sel_hits;
	...
	md_addr_t last_blk_addr; // keep track of last block address
